...
import pic from '../mackie-bday.jpg'
import 'twin.macro'
    ...
    <main tw='flex flex-col max-w-none'>
      ...
      <Container>
        <article tw='prose lg:prose-lg max-w-none py-4 px-4 mb-4'>
          <figure tw='float-left flex flex-col pt-8 pr-6 mb-0!'>
            <img tw='w-64' src={pic} />
          ...
          <p>
            ...
            startups in San Francisco as well as large companies in Detroit and
            throughout the United States, both in-person and remote. In addition
            to these contributions, I have also contributed to various open
            source projects, such as maintaining a couple of widely used ESLint
            plugins for period of time
            <sup>
          ...
          <p>
            ...
            piano, and producing in Ableton Live. I also love to play basketball
            and video games.
          </p>
        </article>
      </Container>
