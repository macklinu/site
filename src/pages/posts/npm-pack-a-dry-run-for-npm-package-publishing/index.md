...
<banner>Heads up! [`npm pack`][npm-pack] now has a `--dry-run` option, which will print the output of `npm pack` to your terminal and not generate a tarball. This wasn't available when this article was originally published. :raised_hands:</banner>
