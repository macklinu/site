...
import defaultExportSyntax from './ast-explorer-export-default.png'
import instanceOfArray from './ast-explorer-instanceof-array.png'
import eslintSelectors from './eslint-selectors.png'
...
<Image src={defaultExportSyntax} alt="AST Explorer for default export syntax" />
...
<Image src={instanceOfArray} alt="AST Explorer for instanceof Array" />
...
<Image src={eslintSelectors} alt="A list of ESLint selectors" />
