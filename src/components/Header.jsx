...
import avatarImage from '@/images/lemon.jpg'
  ...
  return (
    <li>
      ...
      >
        {children}
        {isActive && (
          <span className="absolute inset-x-1 -bottom-px h-px bg-gradient-to-r from-brand-500/0 via-brand-500/40 to-brand-500/0 dark:from-brand-400/0 dark:via-brand-400/40 dark:to-brand-400/0" />
        )}
      </Link>
    </li>
  )
